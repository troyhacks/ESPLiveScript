...
tokenType __keywordTypes[] = {
    TokenKeywordVarType,  TokenKeywordVarType,     TokenKeywordVarType,
    TokenKeywordVarType,  TokenKeywordVarType,     TokenKeywordVarType,
    TokenKeywordVarType,  TokenKeywordVarType,     TokenKeywordVarType,
    TokenKeywordVarType,  TokenKeywordVarType,     TokenKeywordVarType,
    TokenKeywordVarType,  TokenKeywordExternalVar, TokenKeywordFor,
    TokenKeywordIf,       TokenKeywordThen,        TokenKeywordElse,
    TokenKeywordWhile,    TokenKeywordReturn,      TokenKeywordImport,
    TokenKeywordFrom,     TokenKeywordASM,         TokenKeywordDefine,
    TokenKeywordSafeMode, TokenKeywordHeader,      TokenKeywordContent,
    TokenKeywordAnd,      TokenKeywordOr,          TokenKeywordContinue,
    TokenKeywordBreak,    TokenKeywordFabs,        TokenKeywordAbs,
    TokenKeywordSaveReg,  TokenKeywordSaveRegAbs,  TokenKeywordStruct,
    TokenOverride
  ...
  if (_tks->size() > 1) {
    if (_tks->back().type == TokenSubstraction) {
      ...
      if (subtype == TokenComma || subtype == TokenEqual ||
          ...
          subtype == TokenDoubleEqual || subtype == TokenMoreThan ||
          subtype == TokenMoreOrEqualThan || subtype == TokenNotEqual ||
          subtype == TokenStarEqual || subtype == TokenPlusEqual ||
          subtype == TokenOpenParenthesis) {
        str = "-" + str;
        _tks->pop_back();
      }
    }
